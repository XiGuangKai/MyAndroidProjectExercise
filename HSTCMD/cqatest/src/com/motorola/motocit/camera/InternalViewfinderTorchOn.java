...
public class InternalViewfinderTorchOn extends Test_Base
{
    ...
    {
        TAG = "Camera_InternalViewfinderTorchOn";
    ...
    private void startCamera()
    {
        ...
        if (!isSupport)
        {
            Toast.makeText(InternalViewfinderTorchOn.this, "The device does NOT support External Camera", Toast.LENGTH_SHORT).show();
            InternalViewfinderTorchOn.this.finish();
        }
    ...
    SurfaceHolder.Callback surfaceCallback = new SurfaceHolder.Callback()
    {
        ...
        public void surfaceCreated(SurfaceHolder holder)
        {
            ...
            catch (Throwable t)
            {
                ...
                Toast.makeText(InternalViewfinderTorchOn.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        }
                ...
                if (parameters != null)
                {
                    ...
                    if (optimalSize != null)
                    {
                        ...
                        if (!setupFlashMode())
                        {
                            ...
                            Toast.makeText(InternalViewfinderTorchOn.this, "Not support torch on device", Toast.LENGTH_LONG).show();
                            InternalViewfinderTorchOn.this.finish();
                        }
                    }
                }
    ...
    protected void printHelp()
    {
        ...
        strHelpList.add("Camera_InternalViewfinderTorchOn");
        strHelpList.add("");
        strHelpList.add("This function will start the camera and launch the internalviewfinder with the LED on in torch mode");
        strHelpList.add("");
    ...
    {
        contentRecord("testresult.txt", "Camera - InternalViewfinder Torch ON:  FAILED" + "\r\n\r\n", MODE_APPEND);
    ...
    {
        contentRecord("testresult.txt", "Camera - InternalViewfinder Torch ON:  PASS" + "\r\n\r\n", MODE_APPEND);
