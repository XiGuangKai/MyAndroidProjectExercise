...
public class XtalkR extends BlackPattern {

    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        TAG = "TestPattern_Xtalk_Reference";
        super.onCreate(savedInstanceState);

        setRequestedOrientation(1);

        Xtalk_View_Reference xtalk_r = new Xtalk_View_Reference(this);
        setContentView(xtalk_r);
        if (mGestureListener != null)
        {
            xtalk_r.setOnTouchListener(mGestureListener);
        }
    }

    public class Xtalk_View_Reference extends Pattern_View {

        public Xtalk_View_Reference(Context c){
            super(c);
        }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent ev)
    {
        ...
        if (keyCode == KeyEvent.KEYCODE_VOLUME_DOWN)
        {
            ...
            contentRecord("testresult.txt", "Display Pattern - XtalkR:  PASS" + "\r\n\r\n", MODE_APPEND);
        ...
        else if (keyCode == KeyEvent.KEYCODE_VOLUME_UP)
        {
            ...
            contentRecord("testresult.txt", "Display Pattern - XtalkR:  FAILED" + "\r\n\r\n", MODE_APPEND);
