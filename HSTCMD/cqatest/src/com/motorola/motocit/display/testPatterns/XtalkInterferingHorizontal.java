...
public class XtalkInterferingHorizontal extends BlackPattern {

    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        TAG = "TestPattern_Xtalk_Interfering_Horizontal";
        super.onCreate(savedInstanceState);

        setRequestedOrientation(1);

        Xtalk_View_Interfering_Horizontal xtalk_i_h = new Xtalk_View_Interfering_Horizontal(this);
        setContentView(xtalk_i_h);
        if (mGestureListener != null)
        {
            xtalk_i_h.setOnTouchListener(mGestureListener);
        }
    }

    public class Xtalk_View_Interfering_Horizontal extends Pattern_View {

        public Xtalk_View_Interfering_Horizontal(Context c){
            super(c);
        }
        ...
        protected void onDraw(Canvas canvas)
        {
            ...
            for (int rows = 0; rows < 6; rows++)
            {
                for (int cols = 0; cols < 6; cols++)
                {
                    ...
                    if ((cols == 0) || (cols == 1) || (cols == 4) || (cols == 5))
                    {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent ev)
    {
        ...
        if (keyCode == KeyEvent.KEYCODE_VOLUME_DOWN)
        {
            ...
            contentRecord("testresult.txt", "Display Pattern - XtalkInterferingHorizontal:  PASS" + "\r\n\r\n", MODE_APPEND);
        ...
        else if (keyCode == KeyEvent.KEYCODE_VOLUME_UP)
        {
            ...
            contentRecord("testresult.txt", "Display Pattern - XtalkInterferingHorizontal:  FAILED" + "\r\n\r\n", MODE_APPEND);
