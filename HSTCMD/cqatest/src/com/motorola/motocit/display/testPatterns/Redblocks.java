...
public class Redblocks extends BlackPattern{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        TAG = "TestPattern_Redblocks";
        super.onCreate(savedInstanceState);
        setRequestedOrientation(1);

        Redblocks_View redblocks_View = new Redblocks_View(this);
        setContentView(redblocks_View);
        if (mGestureListener != null)
        {
            redblocks_View.setOnTouchListener(mGestureListener);
        }
    }

    public class Redblocks_View extends Pattern_View {

        public Redblocks_View(Context c) {
            super(c);
        }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent ev)
    {
        ...
        {
            contentRecord("testresult.txt", "Display Pattern - Red Blocks:  PASS" + "\r\n\r\n", MODE_APPEND);
        ...
        {
            contentRecord("testresult.txt", "Display Pattern - Red Blocks:  FAILED" + "\r\n\r\n", MODE_APPEND);
