...
public class Grayblocks extends BlackPattern
{
    /**
    ...
    {
        TAG = "TestPattern_Grayblocks";
        super.onCreate(savedInstanceState);

        setRequestedOrientation(1);

        Grayblocks_View grayblocks_View = new Grayblocks_View(this);
        setContentView(grayblocks_View);
        if (mGestureListener != null)
        {
            grayblocks_View.setOnTouchListener(mGestureListener);
        }
    }

    public class Grayblocks_View extends Pattern_View
    {

        public Grayblocks_View(Context c)
        {
            super(c);
        }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent ev)
    {
        ...
        {
            contentRecord("testresult.txt", "Display Pattern - Gray Blocks:  PASS" + "\r\n\r\n", MODE_APPEND);
        ...
        {
            contentRecord("testresult.txt", "Display Pattern - Gray Blocks:  FAILED" + "\r\n\r\n", MODE_APPEND);
