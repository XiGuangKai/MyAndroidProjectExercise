...
public class Medium extends BlackPattern
{

    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        TAG = "TestPattern_Color_Medium";
        super.onCreate(savedInstanceState);

        setRequestedOrientation(1);

        Medium_View medium_View = new Medium_View(this);
        setContentView(medium_View);
        if (mGestureListener != null)
        {
            medium_View.setOnTouchListener(mGestureListener);
        }
    }

    public class Medium_View extends Pattern_View
    {

        public Medium_View(Context c)
        {
            super(c);
        }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent ev)
    {
        ...
        if (keyCode == KeyEvent.KEYCODE_VOLUME_DOWN)
        {
            ...
            contentRecord("testresult.txt", "Display Pattern - Medium:  PASS" + "\r\n\r\n", MODE_APPEND);
        ...
        else if (keyCode == KeyEvent.KEYCODE_VOLUME_UP)
        {
            ...
            contentRecord("testresult.txt", "Display Pattern - Medium:  FAILED" + "\r\n\r\n", MODE_APPEND);
