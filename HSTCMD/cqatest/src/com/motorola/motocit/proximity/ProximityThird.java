...
public class ProximityThird extends Test_Base implements SensorEventListener
{
    ...
    private int thirdProxmityId;
    private Sensor pSensorThird;
    ...
    {
        TAG = "Sensor_ProximityThird";
        super.onCreate(savedInstanceState);

        mSensorManager = (SensorManager) this.getSystemService(SENSOR_SERVICE);

        View thisView = adjustViewDisplayArea(com.motorola.motocit.R.layout.proximity3rd);
    ...
    protected void onResume()
    {
        ...
        if (sensorListenerRegistered == false)
        {
            ...
            {
                Toast.makeText(ProximityThird.this, "The device does NOT support Proximity sensor", Toast.LENGTH_SHORT).show();
                ProximityThird.this.finish();
            }
            ...
            pSensorThird = mSensorList.get(thirdProxmityId);
            fDistance = maximumRange = (int)pSensorThird.getMaximumRange();
            showSensorData();
            ...
            if (wasActivityStartedByCommServer())
            {
                ...
                mSensorManager.registerListener(this, pSensorThird, SensorManager.SENSOR_DELAY_FASTEST);
            }
            else
            {
                dbgLog(TAG, "activity originated UI .. setting update rate to UI rate", 'd');
                mSensorManager.registerListener(this, pSensorThird, SensorManager.SENSOR_DELAY_UI);
            }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent ev)
    {
        ...
        else if (keyCode == KeyEvent.KEYCODE_VOLUME_UP)
        {
            ...
            contentRecord("testresult.txt", "third Proximity:  FAILED" + "\r\n\r\n", MODE_APPEND);
    ...
    protected void handleTestSpecificActions() throws CmdFailException, CmdPassException
    {
        ...
        if (strRxCmd.equalsIgnoreCase("GET_READING"))
        {
            ...
            strDataList.add(String.format("THIRD_PROXIMITY_DISTANCE=" + fDistance));
        ...
        else if (strRxCmd.equalsIgnoreCase("GET_SENSOR_INFO"))
        {
            ...
            strDataList.add(String.format("MAXIMUM_RANGE=" + pSensorThird.getMaximumRange()));
            strDataList.add(String.format("MIN_DELAY=" + pSensorThird.getMinDelay()));
            strDataList.add(String.format("NAME=" + pSensorThird.getName()));
            strDataList.add(String.format("POWER=" + pSensorThird.getPower()));
            strDataList.add(String.format("RESOLUTION=" + pSensorThird.getResolution()));
            strDataList.add(String.format("TYPE=" + pSensorThird.getType()));
            strDataList.add(String.format("VENDOR=" + pSensorThird.getVendor()));
            strDataList.add(String.format("VERSION=" + pSensorThird.getVersion()));
    ...
    {
        contentRecord("testresult.txt", "3rd Proximity:  FAILED" + "\r\n\r\n", MODE_APPEND);
