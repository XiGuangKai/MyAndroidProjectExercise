...
public class Touch_MXT1386 extends Touch_Base
{
    @Override
    public void onCreate(Bundle savedInstanceState)
    {
        TAG = "Touch_MXT1386";
        passMessage = "Touch_MXT1386 passed";
        failMessage = "Touch_MXT1386 failed";
        super.onCreate(savedInstanceState);
        setContentView(new TS_MXT1386_View(this));
    ...
    public class TS_MXT1386_View extends Touch_View
    {
        private float mViewHeight;
        private float mViewWidth;
        private boolean mFirstDraw = true;

        public TS_MXT1386_View(Context c)
        {
            super(c);
        ...
        protected void onDraw(Canvas canvas)
        {
            ...
            if (mFirstDraw)
            {
                ...
                addVertex((float) 1000.0, (float) 666.6, mViewHeight, mViewWidth, mLineSize, mBottom);
                // Point 7 is 0,333.3 (1/3 down Left)
                addVertex((float) 0.0, (float) 333.3, mViewHeight, mViewWidth, mLineSize, mBottom);
            ...
            {
                contentRecord("testresult.txt", "Touch Screen - Touch_MXT1386:  PASS" + "\r\n\r\n", MODE_APPEND);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent ev)
    {
        ...
        if ((keyCode == KeyEvent.KEYCODE_VOLUME_UP) || (keyCode == KeyEvent.KEYCODE_VOLUME_DOWN))
        {
            ...
            contentRecord("testresult.txt", "Touch Screen - Touch_MXT1386:  FAILED" + "\r\n\r\n", MODE_APPEND);
