...
public class Touch_Diagonal extends Touch_Base
{
    @Override
    public void onCreate(Bundle savedInstanceState)
    {
        TAG = "Touch_Diagonal";
        passMessage = "Touch_Diagonal passed";
        failMessage = "Touch_Diagonal failed";
        super.onCreate(savedInstanceState);
        setContentView(new TS_Touch_Diagonal_View(this));
    ...
    public class TS_Touch_Diagonal_View extends Touch_View
    {
        private float mViewHeight;
        private float mViewWidth;
        private boolean mFirstDraw = true;

        public TS_Touch_Diagonal_View(Context c)
        {
            super(c);
        ...
        protected void onDraw(Canvas canvas)
        {
            ...
            {
                contentRecord("testresult.txt", "Touch Screen - Touch_Diagonal:  PASS" + "\r\n\r\n", MODE_APPEND);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent ev)
    {
        ...
        if ((keyCode == KeyEvent.KEYCODE_VOLUME_UP) || (keyCode == KeyEvent.KEYCODE_VOLUME_DOWN))
        {
            ...
            contentRecord("testresult.txt", "Touch Screen - Touch_Diagonal:  FAILED" + "\r\n\r\n", MODE_APPEND);
