...
import com.motorola.motocit.alt.altautocycle.util.CameraPreview;
...
public class ParallelCameraEarpieceProxLightAcceleSDActivity extends
        ALTBaseActivity implements SensorEventListener
{
    ...
    void init()
    {
        try
        {
            this.TAG = "ParallelCameraEarpieceProxLightAcceleSDActivity";
